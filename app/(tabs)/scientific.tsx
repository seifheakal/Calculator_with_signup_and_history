      ...
      <SafeAreaView style={styles.container}>
        ...
        <ScrollView style={styles.scrollContainer} showsVerticalScrollIndicator={false}>
          <View style={styles.buttonContainer}>
            ...
            <CalculatorButton
              title="sin"
              onPress={() => handleFunctionPress('sin')}
              variant="function"
            />
            <CalculatorButton
              title="cos"
              onPress={() => handleFunctionPress('cos')}
              variant="function"
            />
            <CalculatorButton
              title="tan"
              onPress={() => handleFunctionPress('tan')}
              variant="function"
            />
            <CalculatorButton
              title="log"
              onPress={() => handleFunctionPress('log')}
              variant="function"
            />
            ...
            <CalculatorButton
              title="ln"
              onPress={() => handleFunctionPress('ln')}
              variant="function"
            />
            <CalculatorButton
              title="√"
              onPress={() => handleFunctionPress('sqrt')}
              variant="function"
            />
            <CalculatorButton
              title="x^y"
            ...
            <CalculatorButton
              title="π"
              onPress={() => handleNumberPress('3.14159265')}
              variant="function"
            />
